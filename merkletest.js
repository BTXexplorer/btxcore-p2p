let Pool = require('btxcore-p2p').Pool;
let BloomFilter = require('btxcore-p2p').BloomFilter;
let NetworksData = require('btxcore-lib').Networks;
let Messages = require('btxcore-p2p').Messages;
...
// Create a filter and a bitcore message with the filter
...
// Create a bitcore message for require a merkleblock

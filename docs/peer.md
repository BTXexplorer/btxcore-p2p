# Peer
Represents a node from the p2p bitcore network. The Peer class supports connecting directly to other nodes or through a socks5 proxy like Tor.

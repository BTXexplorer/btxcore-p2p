...
function builder(options) {
  ...
  if (!options.network) {
    options.network = btxcore.Networks.defaultNetwork;
  }

  options.Block = options.Block || btxcore.Block;
  options.BlockHeader = options.BlockHeader || btxcore.BlockHeader;
  options.Transaction = options.Transaction || btxcore.Transaction;
  options.MerkleBlock = options.MerkleBlock || btxcore.MerkleBlock;

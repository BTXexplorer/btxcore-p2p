 ...
 * using the standard bitcore protocol. A Peer instance represents one connection
 * on the bitcore network. To create a new peer connection provide the host and port
